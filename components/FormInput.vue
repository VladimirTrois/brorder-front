<template>
    <div class="formInput group" >
        ...
        group-focus-within:border-2 
        group-focus-within:!border-secondComplementary
...
.formInputLabel {
    @apply 
        absolute left-[9px] top-px text-xs text-primary transition-all duration-300 px-1 transform -translate-y-1/2 pointer-events-none
...
.error {
    @apply 
    absolute left-[9px] top-px text-xs text-secondary transition-all duration-300 px-1 transform -translate-y-1/2
    peer-placeholder-shown:top-1/2
    peer-placeholder-shown:text-sm
    group-focus-within:!top-px 
    group-focus-within:!text-xs 
